...
![Build](https://github.com/vksdk/vk-sdk-kotlin/workflows/Release/badge.svg) ![Documentation](https://github.com/vksdk/vk-sdk-kotlin/workflows/Documentation/badge.svg) [![Kotlin 1.4.0-rc](https://img.shields.io/badge/Kotlin-1.4.0_rc-blue.svg?style=flat)](http://kotlinlang.org) [![API version](https://img.shields.io/badge/API%20version-5.103-blue?style=flat&logo=vk&logoColor=white)](https://vk.com/dev/versions)
...
Latest version:  [![maven-central](https://img.shields.io/badge/Maven%20Central-0.0.6_(1.4.0_rc)-yellowgreen?style=flat)](https://search.maven.org/search?q=g:com.petersamokhin.vksdk)
This branch contains the version which is based on the Kotlin 1.4.0-rc.
To be able to use this version, please add `Stately` which is also built with Kotlin 1.4.0-rc.
See the root `build.gradle` and add the dependency for `Stately` in the same way using your GitHub credentials.
